...
hn_all <- read.csv("C:/rproject/startr/hn_all_nojob.csv")
...
# 성별마다 BMI 3분위수, 4분위수로 나눈 HE_BMI_3P, HE_BMI_4P 변수 새로 만들기.
...
## 3등분(23.26 / 25.74), 4등분(22.52, 24.49, 26.54) 기준으로 새로운 변수 만들기

# 3등분

hn_all_m$HE_BMI_3P = 1
hn_all_m$HE_BMI_3P[hn_all_m$HE_BMI>=23.26]=2
hn_all_m$HE_BMI_3P[hn_all_m$HE_BMI>=25.74]=3
...
hn_all_m$HE_BMI_4P[hn_all_m$HE_BMI>=22.52]=2
hn_all_m$HE_BMI_4P[hn_all_m$HE_BMI>=24.49]=3
hn_all_m$HE_BMI_4P[hn_all_m$HE_BMI>=26.54]=4
...
round(quantile(hn_all_f$HE_BMI, c(0.335, 0.665)), 2) # 3등분

round(quantile(hn_all_f$HE_BMI, c(0.25, 0.50, 0.75)), 2) # 4등분

## 3등분(21.54 / 24.32), 4등분(20.78, 22.81, 25.31) 기준으로 새로운 변수 만들기

# 3등분

hn_all_f$HE_BMI_3P = 1
hn_all_f$HE_BMI_3P[hn_all_f$HE_BMI>=21.54]=2
hn_all_f$HE_BMI_3P[hn_all_f$HE_BMI>=24.32]=3
...
hn_all_f$HE_BMI_4P[hn_all_f$HE_BMI>=20.78]=2
hn_all_f$HE_BMI_4P[hn_all_f$HE_BMI>=22.81]=3
hn_all_f$HE_BMI_4P[hn_all_f$HE_BMI>=25.31]=4
...
cat_plot(logit_inter11, pred="HE_BMI_band", modx="occp_inter")

cat_plot(logit_inter11, pred="HE_BMI_band", modx="occp_inter", geom = "line")

cat_plot(logit_inter11, pred="HE_BMI_band", modx="occp_inter", geom = "bar")
...
interact_plot(logit_inter12, pred="HE_BMI", modx="occp_inter")
