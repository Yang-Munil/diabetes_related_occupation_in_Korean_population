...
# 무직(5번)에서 p-value = 0.046으로 유의성 발견.
...
# 무직 모든 경우의 수 로지스틱 모델 summary

summary(logit_model1) # 직업 7 - 남
summary(logit_model2) # 직업 7 - 여
summary(logit_model3) # 직업 5 - 남
summary(logit_model4) # 직업 5 - 여, 무직(5번)에서 p-value = 0.046으로 유의성 발견.
summary(logit_model5) # 직업 4 - 남
summary(logit_model6) # 직업 4 - 여, 서비스직(3)에서 p-value = 0.066 / 무직에서 p-value = 0.00192
